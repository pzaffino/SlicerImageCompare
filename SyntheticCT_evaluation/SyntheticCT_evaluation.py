...
#
# SyntheticCT_evaluation
#

class SyntheticCT_evaluation(ScriptedLoadableModule):
...
#
# SyntheticCT_evaluationWidget
#

class SyntheticCT_evaluationWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    # Create logic object
    self.logic = SyntheticCT_evaluationLogic()
...
#
# SyntheticCT_evaluationLogic
#

class SyntheticCT_evaluationLogic(ScriptedLoadableModuleLogic):
...
class SyntheticCT_evaluationTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_SyntheticCT_evaluation1()

  def test_SyntheticCT_evaluation1(self):
    ...
    logic = SyntheticCT_evaluationLogic()
